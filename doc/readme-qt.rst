AppleCoin-qt: Qt5 GUI for AppleCoin
===============================
...
To use UPnP for port forwarding behind a NAT router (recommended, as more connections overall allow for a faster and more stable applecoin experience), pass the following argument to qmake:
...
The static binary version of AppleCoin is linked against libdb 5.0 (see also `this Debian issue`_).
